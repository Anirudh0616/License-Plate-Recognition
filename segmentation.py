...
license_plate = np.invert(cca2.plate_like_objects[3])
...
character_dimensions = (0.05*license_plate.shape[0], 0.75*license_plate.shape[0], 0.10*license_plate.shape[1], 0.15*license_plate.shape[1])
